...
import { InvalidateGetProductCacheInterceptor } from '../invalidate-get-product-cache.interceptor';
import { of } from 'rxjs';

describe('InvalidateGetProductCacheInterceptor', () => {
	let interceptor: InvalidateGetProductCacheInterceptor;

	beforeEach(async () => {
		interceptor = new InvalidateGetProductCacheInterceptor(cacheManagerMock, {});
	});
